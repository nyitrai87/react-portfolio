        ...
        <Row className="d-flex justify-content-center g-4 bio-row">
            <Col xs={12} md={8} xl={6}>
                <Container className="rounded-3 jumbotron-text">
                    ...
                    <h3>Front-End Developer | Crafting Engaging Web Experiences</h3><br />
                    <p className="fs-5">Hello and welcome on my portfolio website! <br /><br />
                    ...
                    <p className="fs-5">HTML | CSS | JavaScript | Bootstrap | React.js | Node.js | jQuery | Jest | APIs | Firebase | Firestore | Git | GitHub</p>
                </Container>
                <Container className="rounded-3 jumbotron-img mt-4 img-col">
                    <h5 id="grade">My Certificate</h5>
